    ...
    return (
      <div>
        <h2 id="customer-heading">
          <Translate contentKey="gatewayApp.onlineshopCustomer.home.title">Customers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="gatewayApp.onlineshopCustomer.home.createLabel">Create new Customer</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('firstName')}>
                  <Translate contentKey="gatewayApp.onlineshopCustomer.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('lastName')}>
                  <Translate contentKey="gatewayApp.onlineshopCustomer.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('email')}>
                  <Translate contentKey="gatewayApp.onlineshopCustomer.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('telephone')}>
                  <Translate contentKey="gatewayApp.onlineshopCustomer.telephone">Telephone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
